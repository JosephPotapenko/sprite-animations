...
KEYS = {
    ...
    'ranged': ['bow', 'arrow', 'shoot', 'shooting', 'firing', 'fire', 'reload', 'reloading', 'aim', 'quiver', 'archer'],
    'cast': ['cast', 'spell', 'magic', 'summon'],
    'damage': ['damage', 'damaged', 'taking damage', 'take damage', 'wounded', 'impact', 'recoil', 'knockback'],
    'hurt': ['hurt', 'hit'],
    'heal': ['heal', 'healing', 'recover', 'recovery', 'restore', 'restored'],
    'buff': ['buff', 'powerup', 'power-up', 'boost', 'energize', 'charge'],
    'shield': ['shield', 'barrier', 'guard', 'protect', 'protected'],
    'poison': ['poison', 'poisoned', 'toxic', 'venom', 'acid'],
